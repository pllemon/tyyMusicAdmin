<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="服务需求" />
      <el-table-column align="center" label="服务地址" />
      ...
      <el-table-column align="center" label="相关图片" />
      <el-table-column align="center" label="用户备注" />
      <el-table-column align="center" label="订单状态" />
      <el-table-column align="center" label="承接师傅" />
