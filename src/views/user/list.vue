<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="用户账号"></el-table-column>
      <el-table-column align="center" label="用户名"></el-table-column>
      ...
      <el-table-column align="center" label="推荐人"></el-table-column>
      <el-table-column align="center" label="我的朋友"></el-table-column>
      <el-table-column align="center" label="积分"></el-table-column>
      <el-table-column align="center" label="下单情况"></el-table-column>
